...
3. For every character in `s`, increase its frequency.
4. For every character in `t`, decrease its frequency.
5. Finally, check the frequency array.
6. If every value is `0`, both strings contain the same characters with the same frequency.
