...
| **Link** | [View Problem](https://leetcode.com/problems/find-smallest-letter-greater-than-target/) |
| **Runtime** | 0 ms |
| **Memory** | 46.3 MB |
...
**Author**: [@prateekvortex](https://leetcode.com/prateekvortex/)
**Upvotes**: 21 👍
**Link**: [View Original Post](https://leetcode.com/problems/find-smallest-letter-greater-than-target/solutions/694632/)
